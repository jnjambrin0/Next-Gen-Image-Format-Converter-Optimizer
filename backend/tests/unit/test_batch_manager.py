...
class TestBatchManager:
    ...
    @pytest.mark.asyncio
    async def test_create_job_no_conversion_service(
    ...
    async def test_process_task_success(
        self, batch_manager, sample_batch_job, mock_conversion_service
    ):
    ...
    @pytest.mark.asyncio
    async def test_check_job_completion_with_failures(
        self, batch_manager, sample_batch_job
    ):
    ...
    @pytest.mark.asyncio
    async def test_check_job_completion_all_failed(
        self, batch_manager, sample_batch_job
    ):
