...
from backend.app.core.monitoring.errors import ErrorReporter, ErrorReport
...
class TestErrorReporter:
    ...
    async def test_error_summary(self, reporter):
        ...
        assert summary["privacy_notice"] == "All error data has been sanitized to remove PII"
    ...
    async def test_time_based_filtering(self, reporter):
        ...
        old_errors = [e for e in summary_recent.get("most_frequent", []) 
