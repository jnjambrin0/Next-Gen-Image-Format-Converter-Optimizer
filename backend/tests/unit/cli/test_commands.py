...
class TestConvertCommand:
    ...
    def test_convert_file_basic(self, mock_file, mock_validate_output, mock_validate_input, mock_client, runner):
    ...
    @patch('app.cli.commands.convert.validate_input_file')
    @patch('app.cli.commands.convert.validate_output_path')
    def test_convert_file_dry_run(self, mock_validate_output, mock_validate_input, runner):
        """Test dry run mode"""
        mock_validate_input.return_value = True
        mock_validate_output.return_value = True
        
        result = runner.invoke(convert.app, ["file", "test.jpg", "-f", "webp", "--dry-run"])
...
class TestBatchCommand:
    ...
    def test_batch_find_files(self, mock_validate, mock_glob, runner):
        ...
        result = runner.invoke(batch.app, ["convert", "*.jpg", "-f", "webp", "--dry-run"])
    ...
    def test_batch_status(self, mock_client_class, runner):
        ...
        mock_client.__aenter__.return_value.get_batch_status = Mock(return_value=mock_status)
