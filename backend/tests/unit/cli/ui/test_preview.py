...
from app.cli.ui.preview import (
    ImagePreview, PreviewMode, create_ascii_preview,
...
class TestImagePreview:
    ...
    def test_generate_preview_file_too_large(self, mock_console, mock_detector, tmp_path):
    ...
    def test_generate_preview_blocks(self, mock_console, mock_detector, temp_image_file):
    ...
    def test_generate_preview_with_info(self, mock_console, mock_detector, temp_image_file):
    ...
    def test_generate_preview_invalid_image(self, mock_console, mock_detector, tmp_path):
    ...
    def test_generate_preview_dimension_limits(self, mock_console, mock_detector, tmp_path):
    ...
    def test_create_thumbnail_grid(self, mock_console, mock_detector, temp_image_file):
        ...
        with patch.object(preview, 'generate_preview') as mock_gen:
            ...
            result = preview.create_thumbnail_grid(
                [temp_image_file, temp_image_file],
                columns=2,
                mode=PreviewMode.BLOCKS
            )
