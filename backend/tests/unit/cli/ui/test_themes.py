...
from app.cli.ui.themes import (
    ThemeManager, Theme, ThemeType, get_theme_manager
)
...
class TestThemeManager:
    ...
    def test_built_in_themes(self):
        ...
        for theme_type in [ThemeType.DARK, ThemeType.LIGHT, 
                          ThemeType.HIGH_CONTRAST, ThemeType.COLORBLIND_SAFE,
                          ThemeType.MINIMAL]:
