...
from app.cli.documentation.tutorial_engine import (
    TutorialEngine, TutorialStep, TutorialProgress, TutorialStepType
)
...
class TestTutorialEngine:
    ...
    def engine(self, tmp_path):
        ...
        with patch('app.cli.documentation.tutorial_engine.Path.home', return_value=tmp_path):
    ...
    def test_get_tutorial_title(self, engine):
        ...
        assert engine._get_tutorial_title("basic_conversion") == "Basic Image Conversion"
    ...
    def test_execute_quiz_step(self, engine):
        ...
        # Test correct answer
        with patch('app.cli.documentation.tutorial_engine.Prompt.ask', return_value="2"):
            with patch.object(engine.console, 'print') as mock_print:
        ...
        # Test wrong answer
        with patch('app.cli.documentation.tutorial_engine.Prompt.ask', return_value="1"):
            with patch.object(engine.console, 'print') as mock_print:
                result = engine._execute_quiz_step(step)
    ...
    def test_reset_progress(self, engine):
        ...
        # Add again
        engine.progress["test"] = TutorialProgress(tutorial_id="test", current_step=1, total_steps=5)
        engine.progress["test2"] = TutorialProgress(tutorial_id="test2", current_step=2, total_steps=3)
