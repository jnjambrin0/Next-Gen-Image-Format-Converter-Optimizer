...
class TestProfileManager:
    ...
    def test_builtin_profiles_loaded(self, profile_manager):
        ...
        builtin_names = ["web-optimized", "print-quality", "fast-processing", 
                         "archive", "thumbnail"]
    ...
    def test_profile_inheritance_chain(self, profile_manager):
        ...
        grandchild = profile_manager.create_profile(
            ...
            parent="child",
            settings={
                "format": "webp",  # Override
                "grandchild_only": "gc_value"
            }
        )
    ...
    def test_import_duplicate_profile_autorenames(self, profile_manager, temp_config_dir):
    ...
    def test_clone_profile(self, profile_manager):
        ...
        assert cloned.settings == ProfileManager.BUILTIN_PROFILES["web-optimized"].settings
