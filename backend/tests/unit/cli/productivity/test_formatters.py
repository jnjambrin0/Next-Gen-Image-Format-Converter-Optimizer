...
class TestResultFormatter:
    ...
    def test_format_with_custom_fields(self, formatter, conversion_result):
        ...
        options = FormatterOptions(
            fields=["input_file", "output_format", "compression_ratio", "processing_time"]
        )
...
class TestErrorFormatter:
    ...
    def error_data(self):
        ...
        return {
            ...
            "suggestions": [
                "Try converting to WebP instead",
                "Update codec libraries"
            ]
        }
...
class TestFormatterConsistency:
    ...
    def test_all_formats_supported(self, all_formatters, test_data):
        ...
        formats = [FormatType.JSON, FormatType.CSV, FormatType.YAML, 
                   FormatType.XML, FormatType.MARKDOWN]
