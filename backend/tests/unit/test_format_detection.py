...
class TestFormatDetection:
    ...
    def test_detect_webp_by_magic_bytes(self, image_processor):
    ...
    def test_detect_gif_by_magic_bytes(self, image_processor):
    ...
    def test_detect_bmp_by_magic_bytes(self, image_processor):
        """Test BMP detection by magic bytes."""
        # BMP magic bytes
        bmp_data = b"BM" + b"\x00" * 100
        assert image_processor.detect_format(bmp_data) == "bmp"

    def test_detect_tiff_by_magic_bytes(self, image_processor):
    ...
    def test_detect_avif_by_magic_bytes(self, image_processor):
    ...
    def test_detect_heif_by_magic_bytes(self, image_processor):
    ...
    def test_detect_format_fallback_to_pil(self, image_processor):
    ...
    def test_detect_format_empty_data(self, image_processor):
        """Test format detection with empty data."""
        with pytest.raises(InvalidImageError):
            image_processor.detect_format(b"")

    def test_detect_format_too_short_data(self, image_processor):
    ...
    def test_detect_format_unknown_magic_bytes(self, image_processor):
...
class TestMagicByteDetection:
    ...
    def test_magic_byte_detection_returns_none_for_unknown(self, image_processor):
    ...
    def test_magic_byte_detection_short_data(self, image_processor):
