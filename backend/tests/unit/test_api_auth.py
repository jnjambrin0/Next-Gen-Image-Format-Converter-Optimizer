...
class TestApiKeyService:
    ...
    def test_update_api_key(self, service):
        ...
        # Partial update
        updated_key2 = service.update_api_key(
            api_key.id,
            name="Final Name"
        )
    ...
    def test_get_rate_limit_for_key(self, service):
        ...
        # Key with override
        api_key2, _ = service.create_api_key(name="Custom Rate", rate_limit_override=120)
...
class TestOptionalAPIKeyAuth:
    ...
    @pytest.mark.asyncio
    async def test_valid_bearer_token(self, auth_dependency, mock_request, mock_api_key_service):
    ...
    @pytest.mark.asyncio
    async def test_valid_x_api_key_header(self, auth_dependency, mock_request, mock_api_key_service):
    ...
    @pytest.mark.asyncio
    async def test_invalid_api_key(self, auth_dependency, mock_request, mock_api_key_service):
    ...
    @pytest.mark.asyncio
    async def test_api_key_service_error(self, auth_dependency, mock_request, mock_api_key_service):
