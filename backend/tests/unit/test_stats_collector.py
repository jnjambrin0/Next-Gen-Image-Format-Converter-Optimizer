...
class TestStatsCollector:
    ...
    async def test_cleanup_old_stats(self, collector):
        ...
        collector._hourly_stats[recent_hourly_key] = ConversionStats(total_conversions=5)
    ...
    def test_daily_stats_retrieval(self, collector):
        ...
        for i in range(7):
            ...
            collector._daily_stats[day_key] = ConversionStats(
                total_conversions=100 - (i * 10),
                successful_conversions=90 - (i * 10)
            )
