...
from app.services.format_detection_service import FormatDetectionService, format_detection_service
    ...
    async def test_all_standard_formats(self, service, image_samples):
        ...
        for sample_name, sample_data in image_samples.items():
            ...
            if sample_name in expected_formats:
                assert format_name.lower() in expected_formats[sample_name], \
