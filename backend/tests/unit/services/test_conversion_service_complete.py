...
from app.models.conversion import ConversionResult, ConversionRequest, ConversionSettings
...
class TestConversionServiceComprehensive:
    ...
    @pytest.mark.asyncio
    async def test_convert_with_preset_override(self, service, valid_image_data, mock_conversion_manager):
    ...
    @pytest.mark.asyncio
    async def test_convert_with_intelligence_mode(self, service, valid_image_data, mock_conversion_manager):
    ...
    async def test_convert_invalid_formats(self, service, valid_image_data):
        ...
        with patch('app.services.conversion_service.format_detection_service') as mock_detection:
    ...
    @pytest.mark.asyncio
    async def test_convert_security_sandbox(self, service, valid_image_data, mock_conversion_manager):
    ...
    @pytest.mark.asyncio
    async def test_stats_collection_integration(self, service, valid_image_data, mock_conversion_manager):
    ...
    async def test_error_recovery_modes(self, service, mock_conversion_manager):
        ...
        request = ConversionApiRequest(
            output_format="webp",
            settings=ConversionSettings(enable_retry=True)
        )
    ...
    @pytest.mark.asyncio
    async def test_convert_with_advanced_options(self, service, valid_image_data, mock_conversion_manager):
    ...
    async def test_validate_image_comprehensive(self, service):
        ...
        with patch('app.services.format_detection_service.format_detection_service') as mock_detection:
