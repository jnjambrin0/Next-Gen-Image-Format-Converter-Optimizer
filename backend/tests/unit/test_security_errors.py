...
class TestSecurityErrorHandler:
    ...
    def test_handle_security_error(self):
        ...
        error = create_network_error("Network blocked", target_ip="192.168.1.1")
    ...
    def test_error_statistics(self):
        ...
        for _ in range(3):
            handler.handle_error(create_network_error("Network error"))

        for _ in range(2):
            handler.handle_error(create_sandbox_error("Sandbox error"))
