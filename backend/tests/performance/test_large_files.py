...
class TestLargeFilePerformance:
    ...
    def test_streaming_threshold_detection(self, vips_ops):
    ...
    def test_memory_usage_monitoring(self, vips_ops):
        ...
        # Test memory check
        with patch.object(vips_ops, '_get_memory_usage', return_value=initial_memory + 600):
    ...
    def test_chunked_processing(self, vips_ops, large_image_data):
    ...
    def test_memory_estimation(self, vips_ops):
    ...
    def test_memory_monitoring_report(self, vips_ops):
    ...
    @pytest.mark.slow
    def test_large_file_processing_memory_stable(self, vips_ops):
        ...
        assert memory_growth < 200, f"Memory grew by {memory_growth}MB, expected < 200MB"
    
    def test_performance_monitor_lifecycle(self):
    ...
    @pytest.mark.parametrize("file_size_mb,expected_streaming", [
    ...
    def test_streaming_decision_matrix(self, vips_ops, file_size_mb, expected_streaming):
    ...
    def test_vips_save_options_generation(self, vips_ops):
