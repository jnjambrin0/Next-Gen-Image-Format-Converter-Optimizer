...
class CLIRunner:
    ...
    def __init__(self, backend_url: str = "http://localhost:8080"):
        ...
        self.cli_path = Path(__file__).parent.parent.parent.parent / "app" / "cli" / "main.py"
        self.temp_dir = None
    ...
    for i in range(max_retries):
        try:
            ...
            if i < max_retries - 1:
                ...
                pytest.skip("Backend server is not running. Start with: uvicorn app.main:app --port 8080")
