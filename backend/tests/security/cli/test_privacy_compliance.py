...
class TestPrivacyCompliance:
    ...
    def test_no_email_addresses_stored(self, temp_dir) -> None:
        ...
        emails = ["user@example.com", "john.doe@company.org", "admin@localhost"]
    ...
    def test_no_ip_addresses_stored(self, temp_dir) -> None:
        ...
        ips = ["192.168.1.1", "10.0.0.100", "172.16.254.1"]
    ...
    def test_sanitizer_comprehensive_pii_removal(self) -> None:
        ...
        for command, forbidden_strings in complex_commands:
            ...
            for forbidden in forbidden_strings:
                assert (
                    forbidden not in sanitized
                ), f"Found '{forbidden}' in sanitized command"
    ...
    def test_export_contains_no_pii(self, temp_dir) -> None:
        ...
        with patch("app.cli.productivity.autocomplete.get_config_dir") as mock_config:
            ...
            engine.record_command(
                "img batch C:\\Users\\Bob\\Desktop\\*.png --author bob@example.com"
            )
            ...
            if expected is not None:
                if expected == "":
                    ...
                    assert not re.search(
                        r"\.(jpg|jpeg|png|gif|webp)", sanitized, re.IGNORECASE
                    )
            else:
