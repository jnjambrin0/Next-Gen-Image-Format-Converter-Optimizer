...
class TestNetworkIsolation:
    ...
    def test_dependency_telemetry_check(self):
        ...
        for package in packages_to_check:
            assert package in telemetry_findings, f"Missing telemetry check for {package}"
    ...
    def test_no_analytics_imports(self):
        ...
        for module in forbidden_imports:
            assert module not in sys.modules, f"Found forbidden analytics module: {module}"
    ...
    def test_localhost_only_binding(self):
        ...
        assert settings.api_host in ["127.0.0.1", "localhost", "0.0.0.0"], \
