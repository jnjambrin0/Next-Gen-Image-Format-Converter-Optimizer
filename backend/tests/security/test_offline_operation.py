...
class TestOfflineOperation:
        ...
        with NetworkBlocker():
            ...
            for input_fmt, output_fmt in test_formats:
                ...
                try:
                    ...
                    assert result.success is True, f"Failed: {input_fmt} -> {output_fmt}"
    ...
    def test_api_convert_endpoint_offline(self, client, sample_image):
        ...
        with NetworkBlocker():
            ...
            files = {
                'file': ('test.png', sample_image, 'image/png')
            }
            data = {
                'output_format': 'webp',
                'quality': 80,
    ...
    async def test_ml_models_work_offline(self):
        ...
        with NetworkBlocker():
            ...
            with patch('backend.app.core.intelligence.engine.IntelligenceEngine') as mock_engine:
