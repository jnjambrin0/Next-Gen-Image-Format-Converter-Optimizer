...
class TestCompletionScript:
    ...
    def test_command_suggestions(self, generator):
        ...
        # Bash suggestions
        bash_script = generator.generate_with_commands(
            ShellType.BASH, 'img', commands
        )
        for cmd in commands:
    ...
    def test_option_completion(self, generator):
        ...
        script = generator.generate_with_options(
            ShellType.ZSH, 'img', options
        )
...
class TestShellHelper:
    ...
    def test_generate_helper_functions(self, helper):
        ...
        assert 'img_batch_webp()' in batch_helper or 'function img_batch_webp' in batch_helper
    ...
    def test_install_zsh_completion(self, integrator, temp_home):
        ...
        with patch.dict(os.environ, {'HOME': str(temp_home)}):
            ...
            assert (comp_dir / "_img").exists() or \
                   (temp_home / ".zsh" / "functions" / "_img").exists()
    ...
    def test_install_with_existing(self, integrator, temp_home):
        ...
        with patch.dict(os.environ, {'HOME': str(temp_home)}):
            ...
            with patch('builtins.print') as mock_print:
                success = integrator.install(
                    ShellType.BASH, 'img', force=False
                )
...
class TestPlatformSpecific:
    ...
    def test_wsl_integration(self, integrator, tmp_path):
        ...
        with patch.dict(os.environ, {'HOME': str(tmp_path), 'WSL_DISTRO_NAME': 'Ubuntu'}):
