...
from sqlalchemy import Column, String, Boolean, DateTime, Text, Index, UniqueConstraint, Integer, ForeignKey
...
class ApiUsageStats(Base):
    ...
    api_key_id = Column(String(36), ForeignKey('api_keys.id'), nullable=True)  # Nullable for unauthenticated requests
