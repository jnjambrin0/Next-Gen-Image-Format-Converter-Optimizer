...
class BatchResultCollector:
    ...
    def _generate_json_report(
        ...
        report = {
            ...
            "average_processing_time": (
                ...
                if result.successful_files else 0
            ),
    ...
    def _generate_csv_report(
        ...
        # Write header
        writer.writerow([
            "Index", "Filename", "Status", "Output Size (bytes)",
        ...
        writer.writerow(["Total Processing Time (s)", f"{result.processing_time_seconds:.2f}"])
