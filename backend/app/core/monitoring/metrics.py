...
class ConversionMetrics:
    ...
    def size_reduction_percent(self) -> float:
        ...
        if self.input_size_bytes == 0:
            return 0.0
        return ((self.input_size_bytes - self.output_size_bytes) / self.input_size_bytes) * 100
...
class MetricsCollector:
    ...
    def get_aggregate_stats(self) -> Dict[str, Any]:
        ...
        compression_ratios = [m.compression_ratio for m in self._metrics_history 
        ...
        return {
            ...
            "average_compression_ratio": sum(compression_ratios) / len(compression_ratios) if compression_ratios else 0.0,
