...
class FormatAnalyzer:
    ...
    def _init_compatibility_matrix(self):
        ...
        self._add_compatibility(
            ...
            feature_preservation={"color": True, "metadata": True, "transparency": False},
        ...
        self._add_compatibility(
            ...
            feature_preservation={"color": True, "metadata": True, "transparency": False},
            notes=["AVIF offers superior compression", "Some quality loss in conversion"]
        )
        self._add_compatibility(
            "jpeg", "png",
        ...
        self._add_compatibility(
            ...
            compatibility_score=0.95,
            quality_retention=1.0,
            feature_preservation={"color": True, "metadata": True, "transparency": True},
        ...
        self._add_compatibility(
            ...
            feature_preservation={"color": True, "metadata": False, "transparency": False},
    ...
    def get_format_features(self, format_enum: OutputFormat) -> Dict[str, bool]:
        ...
        # Handle aliases
        if format_enum in [OutputFormat.JPG, OutputFormat.JPEG_OPTIMIZED, OutputFormat.JPG_OPTIMIZED]:
        ...
        return feature_db.get(format_enum, {
            "transparency": False,
            "animation": False,
            "hdr": False,
            "lossless": False,
    ...
    def create_comparison_metrics(
        ...
        for format_enum in formats:
            ...
            compression_ratio = self.estimate_compression_ratio(
                InputFormat.PNG,  # Use PNG as baseline
                format_enum,
                content_type
            )
            estimated_size = int(original_size_kb * compression_ratio)
            format_metrics.append(FormatComparisonMetric(
            ...
            if characteristics:
                ...
                format_metrics.append(FormatComparisonMetric(
                    ...
                    display_value=self._speed_label(characteristics.processing_speed),
                    is_better_higher=True
                ))
