...
class PerformanceMonitor:
    ...
    async def record_classification(self, metrics: PerformanceMetrics) -> None:
    ...
    def _get_phase_breakdown(
        ...
        return {phase: statistics.mean(times) for phase, times in all_phases.items()}
