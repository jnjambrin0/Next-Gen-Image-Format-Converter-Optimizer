...
class QuickClassifier:
    ...
    SCREENSHOT_DIMENSIONS = {
        ...
        (3840, 2160), (1280, 720), (1600, 900), (1680, 1050)
    }
    ...
    def classify(self, image: Image.Image) -> ClassificationResult:
        ...
        unique_colors, color_variance, histogram_peaks = self._analyze_colors_fast(image, img_array)
    ...
    def _apply_rules(self, features: Dict[str, float], image: Image.Image) -> Tuple[ContentType, float]:
...
class MLClassifier:
    ...
    def classify(self, image: Image.Image, features: Dict[str, float]) -> ClassificationResult:
