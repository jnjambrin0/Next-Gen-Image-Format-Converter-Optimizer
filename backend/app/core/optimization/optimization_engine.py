...
class OptimizationEngine:
        ...
        **kwargs,
        ...
        for pass_num in range(1, self.max_passes + 1):
            ...
            optimized_data = await conversion_func(
                image_data, output_format, quality=current_quality, **kwargs
            )
            ...
            if (
                ...
                and original_data
                and mode == OptimizationMode.PERCEPTUAL
            ):
    ...
    async def _calculate_perceptual_quality(
        self, passes: list[OptimizationPass], low_quality: int, high_quality: int
    ) -> int:
        ...
        for pass_data in passes:
            if pass_data.ssim_score:
                ...
                ratio = pass_data.ssim_score / (
                    pass_data.file_size / 1024 / 1024
                )  # Per MB
                if ratio > best_ratio:
                    best_ratio = ratio
