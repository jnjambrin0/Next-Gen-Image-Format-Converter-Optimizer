...
class LosslessCompressor:
    ...
    def __init__(self):
        ...
        self._compression_semaphore = asyncio.Semaphore(3)  # Limit concurrent compressions
            ...
            try:
                result = await asyncio.wait_for(
                    self._compress_internal(
                        image_data, output_format, compression_level,
                        preserve_metadata, **kwargs
                    ),
    ...
    async def _compress_internal(
        ...
        **kwargs
        ...
        info["compression_ratio"] = compressed_size / original_size if original_size > 0 else 1.0
    ...
    async def estimate_compression(
        ...
        format_ratios = base_ratios.get(output_format.lower(), {"fast": 1.0, "balanced": 0.9, "maximum": 0.8})
