...
class AlphaOptimizer:
    ...
    async def optimize_alpha(
        ...
        info = {
            ...
            "alpha_usage": "none" if not has_alpha else "simple",  # Added required field
            "removed_alpha": False,
    ...
    async def analyze_alpha_channel(self, image_data: bytes) -> Dict[str, Any]:
        ...
        result = {
            ...
            "recommended_action": self._get_recommendation(alpha_usage, semi_transparent, total_pixels)
        }
