...
class RateLimitError(SecurityError):
    ...
    def __init__(
        ...
        super().__init__(
            code=SecurityErrorCode.RATE_LIMIT_EXCEEDED, message=message, details=details
        )
...
def create_network_error(
    ...
    **details,
    ...
    return NetworkSecurityError(code=code, message=message, details=details)
...
def create_sandbox_error(
    ...
    **details,
    ...
    return SandboxSecurityError(code=code, message=message, details=details)
...
def create_verification_error(
    ...
    **details,
    ...
    return VerificationError(code=code, message=message, details=details)
...
class SecurityErrorHandler:
    ...
    def handle_error(
        ...
        error_mapping = {
            ...
            MemoryError: (
                SecurityErrorCode.SANDBOX_MEMORY_VIOLATION,
                "Memory limit exceeded",
            ),
            PermissionError: (
                SecurityErrorCode.INVALID_FILE_ACCESS,
                "Permission denied",
            ),
        ...
        for error_type, (code, message) in error_mapping.items():
            if isinstance(error, error_type):
                security_error = SecurityError(
                    code=code, message=message, details=context, cause=error
                )
    ...
    def _handle_security_error(
        self, error: SecurityError, context: Dict[str, Any]
    ) -> Dict[str, Any]:
