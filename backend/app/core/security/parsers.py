...
class NetworkConnection:
    ...
    def is_localhost(self) -> bool:
        ...
        return (
            self.remote_addr in LOCALHOST_VARIANTS or
            self.local_addr in LOCALHOST_VARIANTS
        )
    ...
    def _parse_line(self, line: str) -> Optional[NetworkConnection]:
        ...
        try:
            ...
            for i, part in enumerate(parts):
                if part in ["LISTEN", "ESTAB", "ESTABLISHED", "TIME_WAIT", 
                           "CLOSE_WAIT", "SYN_SENT", "SYN_RECV", "FIN_WAIT1", 
                           "FIN_WAIT2", "CLOSING", "LAST_ACK", "CLOSED"]:
                    state_idx = i
                    break
