...
class Macro:
    ...
    def to_dict(self) -> Dict:
        ...
        for cmd in data["commands"]:
            cmd["security_level"] = cmd["security_level"].value if isinstance(cmd["security_level"], MacroSecurity) else cmd["security_level"]
        return data
        ...
        if "commands" in data:
            ...
            for cmd_data in data["commands"]:
                if "security_level" in cmd_data:
                    cmd_data["security_level"] = MacroSecurity(cmd_data["security_level"])
...
class MacroSandbox:
    ...
    def export_macro(self, name: str, output_file: Path, remove_pii: bool = True) -> bool:
        """
    ...
    def import_macro(self, input_file: Path, rename: Optional[str] = None) -> Optional[Macro]:
        """
        ...
        try:
            ...
            for cmd in macro.commands:
                security_level, warnings = CommandValidator.validate_command(cmd.command)
