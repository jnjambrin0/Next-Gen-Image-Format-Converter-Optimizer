...
class KnowledgeBase:
    ...
    def _init_search_index(self):
        ...
        try:
            ...
            self.console.print(f"[yellow]Search index initialization failed: {e}[/yellow]")
...
```""",
    ...
    def _whoosh_search(self, query: str, limit: int) -> List[Question]:
        ...
        parser = qparser.MultifieldParser(
            ["question", "answer", "tags", "error_codes"],
    ...
    def export_knowledge(self, filepath: Path):
        ...
        self.console.print(f"[green]✓[/green] Exported {len(questions)} Q&A entries to {filepath}")