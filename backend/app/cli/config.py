...
class CLIConfig(BaseModel):
    ...
    default_output_format: str = Field(
        default="rich",
        description="Default output format (rich, json, plain)"
    )
    ...
    # Features
    aliases_enabled: bool = Field(
        default=True,
        description="Enable command aliases"
    )
    ...
    history_enabled: bool = Field(
        default=True,
        description="Enable command history for undo/redo"
    )
    ...
    default_quality: int = Field(
        default=85,
        description="Default quality for lossy formats (1-100)"
    )
    default_preset: Optional[str] = Field(
        default=None,
        description="Default optimization preset"
    )
    preserve_metadata: bool = Field(
        default=False,
        description="Preserve image metadata by default"
    )
