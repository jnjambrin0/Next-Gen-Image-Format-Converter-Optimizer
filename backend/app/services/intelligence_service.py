...
class IntelligenceService:
    ...
    async def analyze_image(
        ...
        try:
            ...
            # Track results
            if self.stats_collector:
                await self.stats_collector.track_event("intelligence_analysis", {
    ...
    async def get_optimization_recommendations(
        ...
        try:
            recommendations = self.engine.recommend_settings(content_type, target_format)
            
            # Track recommendation request
            if self.stats_collector:
                await self.stats_collector.track_event("intelligence_recommendation", {
