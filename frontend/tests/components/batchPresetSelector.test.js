...
describe('BatchPresetSelector', () => {
  ...
  describe('metadata preservation', () => {
    it('should toggle metadata preservation', () => {
      ...
      const metadataCheckbox = Array.from(checkboxes).find((cb) =>
        cb.nextElementSibling?.textContent.includes('Preserve metadata')
      )
    ...
    it('should show metadata warning', () => {
      ...
      const warning = Array.from(container.querySelectorAll('.text-yellow-600')).find((el) =>
        el.textContent.includes('location and personal information')
      )
  ...
  describe('apply to all', () => {
    it('should toggle apply to all setting', () => {
      ...
      const checkboxes = container.querySelectorAll('input[type="checkbox"]')
      const applyCheckbox = Array.from(checkboxes).find((cb) =>
        cb.nextElementSibling?.textContent.includes('Apply these settings to all')
      )
