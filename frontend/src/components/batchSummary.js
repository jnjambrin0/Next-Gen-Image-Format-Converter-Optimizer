...
export class BatchSummaryModal {
  ...
  render() {
    ...
    panel.className = 'relative bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-hidden'
  ...
  createFooter() {
    ...
    if (this.results.failed_files?.length > 0) {
      ...
      retryButton.className = 'px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'
    ...
    downloadButton.className = 'px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500'
    ...
    // Close button
    const closeButton = document.createElement('button')
    closeButton.className = 'px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500'
