...
export class BatchPresetSelector {
  ...
  createMetadataSection() {
    ...
    warning.textContent =
      'Warning: Preserving metadata may include location and personal information'
  ...
  createSummary() {
    ...
    const selectedMode = this.optimizationModes.find(
      (m) => m.value === this.settings.optimizationMode
    )
